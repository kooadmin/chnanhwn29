        ...
        <div class="col-lg">
            <div class="card">
                <div class="card-body shadow shadow">
                    ...
                    <img src="img/ct/com.png" class="card-img-top" id="imgcontent">
                </div>
            </div>
        </div>
        <div class="col-lg">
            <div class="card">
                <div class="card-body shadow shadow">
                        ...
                        <div class="accordion-item shadow">
                            <h2 class="accordion-header">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                    <b>การพัฒนาโครงงานทางด้านเทคโนโลยี</b>
                                </button>
                            </h2>
                    ...
                    <img src="img/ct/Picture1.png" class="card-img-top" id="imgcontent">
                </div>
            </div>
        </div>
        <div class="col-lg">
            <div class="card">
                <div class="card-body shadow shadow">
                        ...
                        <div class="accordion-item shadow">
                            <h2 class="accordion-header">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                    <b>การเขียนรายงานการพัฒนาโครงงาน</b>
                                </button>
                            </h2>
                    ...
                    <img src="img/ct/pngegg.png" class="card-img-top" id="imgcontent">
                </div>
            </div>
        </div>
    </div>
